...
NavButtonGroup::NavButtonGroup(QWidget *parent) : QWidget(parent)
{
    ...
    btnNormalColor = QColor(24, 45, 68);
    btnHoverColor = QColor(255, 255, 255, 100);
    btnDarkColor = QColor(24, 45, 68, 180);
    textNormalColor = QColor(217, 217, 217);
    textHoverColor = QColor(217, 217, 217);
    textDarkColor = QColor(222, 125, 44);
